...
class Report:
    ...
    def create(self):
        ...
        data = {
            ...
            "job_type_lower": JobType[self.featureset].title.lower(),
            "model_confidence": PrecisionRecall.get(alert, recall_alert).alert.tag,
            "alert_level": alert.tag,
            "score_name": self.scoring.replace("-", " ").capitalize(),
            "score_level": alert.tag,
